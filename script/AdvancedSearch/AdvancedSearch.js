...
async function Website_FullSearch() {
    if (!document.querySelector("div#FullSearch_PopUp")) {
        ...
        fullSearchBar.setAttribute("placeholder", "Search Game")
        ...
        all_itens.id = "active"
        all_itens.innerText = "All Content";
        ...
        subTab_gamesLabel.innerHTML = "Games <i class='fa-solid fa-arrow-right'></i>";
        ...
        subTab_modsLabel.innerHTML = gameNameFull + " - Recently Popular Mods <i class='fa-solid fa-arrow-right'></i>";
        ...
        subTab_collectionsLabel.innerHTML = gameNameFull + " - Best Collections <i class='fa-solid fa-arrow-right'></i>";
        ...
        subTab_imagesLabel.innerHTML = gameNameFull + " - Images Recently Endorsed <i class='fa-solid fa-arrow-right'></i>";
        ...
        subTab_videosLabel.innerHTML = gameNameFull + " - Vídeos Recently Endorsed <i class='fa-solid fa-arrow-right'></i>";
